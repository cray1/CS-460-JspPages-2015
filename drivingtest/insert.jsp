...
<title>Insert Driving Test</title>
</head>
<body>
	...
	<form action="/drivingtest/insertdb.jsp" method="post">
		<table>
			<thead>
				<tr>
					<th colspan="2">Insert Driving Test</th>
				</tr>
			</thead>
			<tbody>
				<tr>
					<td><label>DrivingTestId</label></td>
					<td><input type="number" name="drivingtestid" min="1"
						max="9999" /></td>
				</tr>
				<tr>
